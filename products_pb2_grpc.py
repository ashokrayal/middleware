...
class ProductServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.PlaceOrder = channel.unary_unary(
                '/products.ProductService/PlaceOrder',
                request_serializer=products__pb2.OrderRequest.SerializeToString,
                response_deserializer=products__pb2.OrderResponse.FromString,
                )
        self.UpdateOrder = channel.unary_unary(
                '/products.ProductService/UpdateOrder',
                request_serializer=products__pb2.OrderRequest.SerializeToString,
                response_deserializer=products__pb2.OrderResponse.FromString,
                )
...
def add_ProductServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'PlaceOrder': grpc.unary_unary_rpc_method_handler(
                    servicer.PlaceOrder,
                    request_deserializer=products__pb2.OrderRequest.FromString,
                    response_serializer=products__pb2.OrderResponse.SerializeToString,
            ),
